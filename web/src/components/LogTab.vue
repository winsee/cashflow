...
const LABELS: Record<string, string> = {
  ...
  FT_DREAM_BOUGHT: '买下梦想', FT_DREAM_DOUBLED: '梦想加价', FT_DREAM_CLAIMED: '买下梦想占位',
  FT_CHARITY_DONATED: '快车道慈善',
...
const DOT: Record<string, string> = {
  ...
  FT_DREAM_BOUGHT: COLOR_DREAM, FT_DREAM_DOUBLED: COLOR_DREAM, FT_DREAM_CLAIMED: COLOR_DREAM,
