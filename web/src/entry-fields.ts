...
export const FIELDS: Record<string, [string, string, 'n' | 's'][]> = {
  REALESTATE: [['assetType', '资产类型(如 3室2厅)', 's'], ['cost', '成本', 'n'], ['downPayment', '首期支付', 'n'], ['mortgage', '抵押贷款', 'n'], ['cashflow', '月现金流', 'n'], ['roiPct', '收益率%', 'n'], ['priceRange.0', '价格区间低(选填)', 'n'], ['priceRange.1', '价格区间高(选填)', 'n']],
